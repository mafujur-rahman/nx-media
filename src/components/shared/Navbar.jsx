  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center px-4">
      <nav className="flex items-center gap-8 bg-black/80 backdrop-blur-md px-8 py-3 rounded-2xl border border-white/10 shadow-2xl">
        ...
        <button className="flex items-center gap-3 bg-white/5 border border-red-500/50 px-5 py-2 rounded-xl group hover:border-red-400 transition-all shadow-[0_0_15px_rgba(168,85,247,0.2)]">

            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-12 gap-10">
                    ...
                    <div className="md:col-span-9 grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.duration?.discovery}</h4>
                            <p className="mt-4 text-white/50">Accelerated Discovery</p>
                        </div>
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.duration?.design}</h4>
                            <p className="mt-4 text-white/50">Design Execution</p>
                        </div>
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.duration?.support}</h4>
                ...
                <div className="grid md:grid-cols-12 gap-10">
                    ...
                    <div className="md:col-span-9 grid sm:grid-cols-2 lg:grid-cols-3 gap-12">
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.success?.milestone1}</h4>
                            <p className="mt-4 text-white/50">Validated Product Strategy</p>
                        </div>
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.success?.milestone2}</h4>
                            <p className="mt-4 text-white/50">Operational Rollout</p>
                        </div>
                        <div>
                            <h4 className="text-3xl font-medium text-white/80">{project?.success?.milestone3}</h4>

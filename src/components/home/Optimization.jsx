...
export default function Optimization() {
    return (
        <section className="relative bg-[#121212] text-white py-24 px-6 md:px-20 overflow-hidden">

            <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-16">

                {/* LEFT SIDE: CALENDLY BUTTON (TOP ALIGNED) */}
                ...
                <div className="w-full lg:w-1/2">
                    <h2 className="text-4xl md:text-5xl font-black leading-none tracking-tighter uppercase mb-8">
                        <span className="block text-white">Beyond Generic</span>
                        <span className="block text-white">
                            Training — <span className="text-gray-500">Your</span>
                        </span>
                        <span className="block text-gray-500">Personal Path to</span>
                        <span className="block text-gray-500">Peak Optimization</span>
                    </h2>

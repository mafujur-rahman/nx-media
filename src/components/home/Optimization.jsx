      ...
      <div className="relative z-10 xl:max-w-7xl xl:mx-auto flex flex-col lg:flex-row items-start gap-16">
        ...
        <div className="w-full lg:w-1/3 flex justify-start">
          <button
            ...
            className="group relative w-full max-w-xl bg-[#eeeeee] text-gray-600 flex items-center justify-between px-8 py-5 rounded-full transition-all duration-500 cursor-pointer shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:shadow-[0_0_60px_rgba(255,255,255,0.5)]"
          >
